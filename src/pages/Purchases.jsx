            ...
            <div className="p-4">
              <div className="space-y-4">
                {purchases.slice(0, 5).map((purchase) => (
                  <div key={purchase.id} className="border-b pb-4 last:border-b-0 last:pb-0">
                    ...
                    <div className="mt-1 text-sm text-gray-500">
                      Quantity: {purchase.quantity} @ ${purchase.costPerUnit.toFixed(2)}/unit
                    </div>
                    {purchase.supplier && (
                      <div className="mt-1 text-sm text-gray-500">
                ...
                {purchases.length === 0 && (
                  <p className="text-center text-gray-500">No recent purchases</p>
                )}
              </div>
            </div>
          </div>
